	...
	render: function() {
		return (
			React.createElement("div", null, 
				...
				React.createElement("p", null, this.props.appName)
			)
		)
	}
});
	...
	render: function() {
		...
		return (
			React.createElement("section", null, 
				...
				React.createElement("h2", null, " What im typing: ", this.state.newPokemon), 
				React.createElement("ul", null, 
					ourPokemon
				), 
				React.createElement("input", {type: "text", value: this.state.newPokemon, onChange: this.updateNewPokemon}), 
				React.createElement("button", {onClick: this.handleNewPokemon}, "Add Pokemon")
...
var PokemonListContainer = React.createClass({displayName: "PokemonListContainer",
	...
	*/
	...
	render: function() {
		return (
			React.createElement(PokemonList, {addPokemon: this.addPokemon, pokemonList: this.state.pokemon})
		)
	}
})
...
},{"./PokemonList.jsx":4,"react":161,"superagent":162}],6:[function(require,module,exports){
